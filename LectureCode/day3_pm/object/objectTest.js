...
(() => {
  ...
  const myObject = {
    ...
    foo: function () {
      return myObject.a;
      //return this.a; // this is bad
    },
    // foo() { return this.a }              // syntactic sugar
  };
  ok.push(myObject.foo() === 1); // this wird links vom punkt aufgelöst -> zu myObject, links ist callside

  /* // possible to change object property method -> security issue
  ...
  */
  ...
  ok.push(myFunctions[0]() === 1); // undefined with this.a
  ...
  //ok.push(outer(inner) === 2); // outer(inner) is  undefined
